...
#             print 'converged in %d iterations ' % iterations
    def fit(self, X, y, X_scaled,X_untouched) :
        """
...
#             print self.w
        ...
        for v in range(len(arrayToI)) :
#             arra_of_ein.append(self.geteot(X[:arrayToI[v]]))
            self.genw(X_untouched[:arrayToI[v]])
#             print 'w'
#             print self.w
            array_of_eout_untouch.append(self.geteot(X_untouched))
            
#         print 'Final w'
#         print self.w   
        print 'Iteration Used', self.max_iterations
        print 'Learning Rate', self.learning_rate
        print 'Eout Set Standardized', array_of_eout
        print 'Eout Set Scale', array_of_eout_scale

#         print 'array In', arra_of_ein
#         print 'array Of I', arrayToI
        plot_LC(arra_of_ein, array_of_eout, array_of_eout_scale, array_of_eout_untouch, arrayToI)
#         array_of_eout.append(self.geteot(X))
...
#     print data
    ...
    X_untouched = np.asarray(inputArray)
...
#     print 'new Y', y
    ...
    return X,y,w,X_scaled, X_untouched

def plot_LC(arra_of_ein, array_of_eout, array_of_eout_scale, array_of_eout_untouch, arrayToI) :
#     print arra_of_ein
...
#         plt.plot(arrayToI[i], arra_of_ein[i], 'r'+'o')
        ...
        ax.plot(arrayToI[i], array_of_eout_untouch[i])


#     plt.plot(arrayToI, arra_of_ein)
    ax.plot(arrayToI, array_of_eout_untouch, label = 'Out-Of-Sample Error Using Original Dataset')

    ax.plot(arrayToI, array_of_eout, label = 'Out-Of-Sample Error Using Standardized Dataset')
...
if __name__=='__main__' :
    X,y,w,X_scaled,X_untouched = generate_separable_data()
    p = Perceptron()
#     print 'X'
#     print X
#     print 'Y'
#     print y
    p.fit(X,y,X_scaled,X_untouched)
